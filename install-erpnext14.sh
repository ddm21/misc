...
#inorder to install production bench needed to be start which will be used in installing any apps so keep bench running untill apps are installing
...
# Ask if they want to create new user, this will be used to create and save ssl details, before installing ssl ask user if they want to setup ssl
